...
item_id: "VER.002"
requirements: []
evidence_items: ["LEA-MOVS-PROCEDURE"]
---
...
- **LEA-MOVS-PROCEDURE**: MOVS 적용 범위에 포함된 운영모드에 대해 검증 절차의 각 단계를 수행한다.

`LEA-053`은 활성 규칙에서 다른 의미로 사용되었던 식별자이므로 본 파생 문서에서 사용하지 않는다.
